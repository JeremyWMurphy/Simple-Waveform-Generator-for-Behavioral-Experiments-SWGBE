...
It uses [IntervalTimer](https://www.pjrc.com/teensy/td_timing_IntervalTimer.html) library ti run at 5 kHz, which is just fine for the Moore Lab's tactile detection experiments.
